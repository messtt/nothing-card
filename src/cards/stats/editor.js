...
export const configForm = () => ({
  schema: [
    ...
    { name: "name", selector: { text: {} } },
    {
      ...
      name: "",
      schema: [
        { name: "period", selector: { select: { mode: "dropdown", options: ["5minute", "hour", "day", "week", "month"] } } },
        { name: "stat", selector: { select: { mode: "dropdown", options: ["mean", "max", "min", "sum", "change", "state"] } } },
